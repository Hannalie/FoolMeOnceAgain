...
public class TestForPlayerMoveMent : MonoBehaviour
{
    public class PlayerMovement : MonoBehaviour
    {
        [SerializeField] private Rigidbody2D rbOne;
        ...
        private void Update()
        {
            ...
            {
                isJumping = true;
                rbOne.velocity = Vector2.up * jumpForce;
            }
            ...
            {
                isCrouching = true;
                capsuleCollider.size = new Vector2(capsuleCollider.size.x * 0.5f, capsuleCollider.size.y);

            }

            if (isJumping && Input.GetButton("Crouch"))
            {
                capsuleCollider.size = new Vector2(capsuleCollider.size.x * 1f, capsuleCollider.size.y);
            }
        ...
        void FixedUpdate()
        {
            ...
            rbOne.velocity = new Vector2(moveSpeed, rbOne.velocity.y);
        }
